          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <Image
                ...
                width={600}
                height={400}
                className="relative z-10 rounded-3xl shadow-2xl hover:scale-105 transition-transform duration-300 sm:opacity-20 md:opacity-40 lg:opacity-100 sm:absolute sm:inset-0 sm:z-[-10] sm:scale-150 md:scale-125 lg:scale-100 lg:relative lg:z-10"
              />
            </div>
          </div>
        </div>
